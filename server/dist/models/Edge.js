...
const EdgeSchema = new mongoose_1.Schema({
    from: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Node', required: true, index: true },
    to: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Node', required: true, index: true },
    label: {
        type: String,
...
exports.default = mongoose_1.default.model('Edge', EdgeSchema);
